...
function XToLevel.Player:GetMaxLevel()
    if self.maxLevel == nil then
        ...
        if interfaceNumber < 20000 then
            self.maxLevel = 60  -- Vanilla Classic
        elseif interfaceNumber < 30000 then
            self.maxLevel = 70  -- TBC Classic / Anniversary
        elseif interfaceNumber < 40000 then
            self.maxLevel = 80  -- WotLK Classic
        else
            self.maxLevel = _G.MAX_PLAYER_LEVEL or 60
        end
    end
